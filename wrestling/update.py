...
class WrestlingDatabase:
    ...
    def generate_next_wts_if_ready(self, path, opmod):
        ...
        setup_rows = [(mtype, weight, note, ('xx', ''), ('xx', ''))
                      for mtype, weight, note in template
                      if not self.is_title_match(note)[0]]

        # One title defence per contender crowned two editions ago.
        title_rows, dropped = [], []
...
<ul class="wiki-nav">
    ...
    <li><a href="/wrestling/org/wwf.html">World Wrestling Federation</a></li>
    <li><a href="/wrestling/org/wwo.html">World Wrestling Organization</a></li>
    <li><a href="/wrestling/org/iwb.html">International Wrestling Board</a></li>
